#Embedded file name: /Users/curtislagraff/.virtualenvs/amber-lib/amber-lib/benchmarking/create.py
...
class Old(object):
    ...
    def test(self):
        self.amber_client.add_product({'identity': {}})
