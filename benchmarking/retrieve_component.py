#Embedded file name: /Users/curtislagraff/.virtualenvs/amber-lib/amber-lib/benchmarking/retrieve_component.py
...
class NewCached(object):
    ...
    def test(self):
        self.conn.Product.retrieve(1).identity
...
class Old(object):
    ...
    def test(self):
        self.amber_client.get_product_component(36197, 'identity')
