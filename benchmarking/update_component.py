#Embedded file name: /Users/curtislagraff/.virtualenvs/amber-lib/amber-lib/benchmarking/update_component.py
...
class Old(object):
    ...
    def test(self):
        self.amber_client.update_product_component(36197, 'identity', {})
