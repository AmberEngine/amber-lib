...
class Product(Model):
    ...
    foundation_information = Property(components.FoundationInformation)
    ...
    mattress_compliances = Property(components.MattressCompliances)
    mattress_features = Property(components.MattressFeatures)
    mattress_information = Property(components.MattressInformation)
    mattress_specifications = Property(components.MattressSpecifications)
