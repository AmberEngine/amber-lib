...
class Hash(Component):
    ...
    category_tags = Property(str)
    collection = Property(str)
    com_col = Property(str)
    construction_information = Property(str)
    covers = Property(str)
    cushions = Property(str)
    description = Property(str)
    doors = Property(str)
    drawers = Property(str)
    durability = Property(str)
    electrical = Property(str)
    fiber = Property(str)
    flame = Property(str)
    footboard = Property(str)
    footrest = Property(str)
    foundation_information = Property(str)
    frame = Property(str)
    glass = Property(str)
    groups = Property(str)
    headboard = Property(str)
    identity = Property(str)
    interior_dimension = Property(str)
    instruction = Property(str)
    keyword = Property(str)
    leather = Property(str)
    manufacturer = Property(str)
    mattress_compliances = Property(str)
    mattress_features = Property(str)
    mattress_information = Property(str)
    mattress_specifications = Property(str)
    option_sets = Property(str)
    ordering_information = Property(str)
    overall_dimension = Property(str)
    pattern = Property(str)
    pedestal = Property(str)
    pillows = Property(str)
    pricing = Property(str)
    inventory = Property(str)
    rug_construction = Property(str)
    rug_pattern = Property(str)
    seat = Property(str)
    shade = Property(str)
    shelves = Property(str)
    shipping_information = Property(str)
    side_rail = Property(str)
    suspension_point = Property(str)
    table_leaves = Property(str)
    textile = Property(str)
    visibility = Property(str)
    weight = Property(str)
